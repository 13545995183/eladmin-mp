...
public class CollecBankWithdrawalRecordController {
    ...
    @ApiOperation("添加")
    @PostMapping("/add")
    public ResultEntity add(@RequestBody CollecBankWithdrawalRecord collecBankWithdrawalRecord){
    ...
    @ApiOperation("修改")
    @PostMapping("/edit")
    public ResultEntity edit(@RequestBody CollecBankWithdrawalRecord collecBankWithdrawalRecord){
